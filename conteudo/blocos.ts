...
export const BLOCOS: Bloco[] = [
  {
    ...
    slides: [
      ...
      },
      {
        ...
        notaApresentador: "Pergunta no chat, uma palavra. Leia 3 ou 4 respostas em voz alta — 1 a 2 min.",
      },
  ...
  },
  {
    ...
    slides: [
      { id: "5.1", tipo: "cena", cena: "c4", marcaHora: "16:20" },
      {
        ...
        visual: "alternancia",
        marcaHora: "16:20",
        notaApresentador: "Experimento com a sala: contar A B C… e 1 2 3…, depois intercalar A1 B2 C3. Cronometre em voz alta.",
      },
    ...
    slides: [
      {
        ...
        notaApresentador: "A dinâmica roda no Kahoot da EDC, não neste deck. Troque de tela aqui.",
      },
    ],
  },
  {
