    ...
    slides: [
      {
        ...
        personagemId: "rafael",
        hora: "8h00",
        situacao: "Analista, 34 anos. Chega cedo e promete a si mesmo: hoje eu foco 5 horas sem levantar.",
      },
      {
        id: "2.2",
        tipo: "cena",
        personagemId: "rafael",
        hora: "11h40",
        situacao: "Terceira vez que relê o mesmo parágrafo do relatório. Não entra.",
    ...
    slides: [
      {
        ...
        hora: "9h00",
        situacao: "Coordenadora, 41 anos. A manhã inteira respondendo mensagens curtas, apagando pequenos incêndios.",
      },
      {
        id: "3.2",
        tipo: "cena",
        personagemId: "luciana",
        hora: "15h00",
        situacao: "Precisa aprovar o orçamento do trimestre. Olha a planilha e não consegue decidir nada.",
    ...
    slides: [
      {
        ...
        hora: "14h00",
        situacao: "Atendimento, 28 anos. Um cliente grita ao telefone logo depois de uma cobrança difícil.",
      },
      {
        id: "4.2",
        tipo: "cena",
    ...
    slides: [
      {
        ...
        personagemId: "marcos",
        hora: "16h00",
        situacao: "Gerente comercial, 45 anos. E-mail, chat e planilha abertos ao mesmo tempo — \"respondo tudo junto\".",
      },
      {
        id: "5.2",
        tipo: "cena",
        personagemId: "marcos",
        hora: "16h20",
        situacao: "Manda a proposta. Um zero a mais no valor. Ninguém percebe até o cliente ligar.",
